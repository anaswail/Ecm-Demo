...
import type { ModuleChallenges as ModuleChallengesData } from "../../../../data";
import { useAppContext } from "../../../../context/AppContext";
import Eyebrow from "../../../../components/ui/Eyebrow";

type ModuleChallengesProps = ModuleChallengesData;
          ...
          {items.map(
            (
              ...
              return (
                ...
                >
                  <span className="flex h-10 w-10 items-center justify-center rounded-lg border border-border bg-bg-main text-ink">
